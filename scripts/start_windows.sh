...
gcloud beta compute instances create winvm --image=windows-server-1803-dc-core-for-containers-v20180802 --image-project=windows-cloud --machine-type n1-standard-4 --scopes=cloud-platform,storage-full
